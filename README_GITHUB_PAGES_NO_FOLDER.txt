Task Payment Tracker PWA v19 - flat upload
...
After upload, open your GitHub Pages link with ?v=19 at the end once, for example:
https://yourusername.github.io/your-repo-name/?v=19
...
- PWA cache updated to v19

If the iPhone Home Screen app still loads an old version, remove the old Home Screen icon, open the ?v=19 link in Safari, refresh once, and add it to Home Screen again.
